    ...
    for tab in tabs:
        ...
        for value in values:
            ...
            try:
                ...
                log = Log(from_sheet=spreadsheetId, to_sheet=output_spreadsheet, from_tab=tab, to_tab=out, updated_at=timezone.now(),
                        updated_row=row_number, updated_col=len(value), status="Error")
                log.save()
            ...
            l = len(value)
    log = Log(from_sheet=spreadsheetId, to_sheet=output_spreadsheet, from_tab=tab, to_tab=out, updated_at=timezone.now(),
            updated_row=row_number, updated_col=l, status="Completed")
    log.save()
